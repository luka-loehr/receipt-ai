...
def test_calendar_api():
    ...
    try:
        ...
        elif os.path.exists('tokens_autogenerated/calendar_token.json'):
...
def test_gmail_api():
    ...
    try:
        ...
        if os.path.exists('tokens_autogenerated/unified_google_token.json'):
            creds = Credentials.from_authorized_user_file('tokens_autogenerated/unified_google_token.json', SCOPES)
        elif os.path.exists('tokens_autogenerated/gmail_token.json'):
...
def test_tasks_api():
    ...
    try:
        ...
        if os.path.exists('tokens_autogenerated/unified_google_token.json'):
            creds = Credentials.from_authorized_user_file('tokens_autogenerated/unified_google_token.json', SCOPES)
        elif os.path.exists('tokens_autogenerated/tasks_token.json'):
...
def unified_google_oauth():
    ...
    try:
        ...
        if not creds or not creds.valid:
            ...
            os.makedirs('tokens_autogenerated', exist_ok=True)
            with open('tokens_autogenerated/unified_google_token.json', 'w') as token:
