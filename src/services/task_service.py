...
class TaskService:
    ...
    def __init__(self, config: AppConfig):
        ...
        if not os.path.exists('token_autogenerated/unified_google_token.json'):
            ...
            print(f"⚠️  Warning: No Google unified token found. Task data will be {mode}.")
    ...
    def get_tasks(self) -> List[TaskData]:
        ...
        if not os.path.exists('token_autogenerated/unified_google_token.json'):
            ...
            return self._get_mock_tasks() if self.config.allow_mock_data else []
    ...
    def get_tasks_from_list(self, list_name: str) -> List[TaskData]:
        ...
        if not os.path.exists('token_autogenerated/unified_google_token.json'):
            print("❌ No unified Google token found. Run setup.py to authorize.")
            return self._get_mock_shopping_items() if self.config.allow_mock_data else []
