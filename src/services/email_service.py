...
class EmailService:
    ...
    def __init__(self, config: AppConfig):
        ...
        # Keyword-based priority/spam filtering removed; AI will infer importance
        ...
        if not os.path.exists('token_autogenerated/unified_google_token.json'):
            ...
            print(f"⚠️  Warning: No Google unified token found. Email data will be {mode}.")
    ...
    def get_recent_emails(self) -> List[EmailData]:
        ...
        if not os.path.exists('token_autogenerated/unified_google_token.json'):
            ...
            return self._get_mock_emails() if self.config.allow_mock_data else []
