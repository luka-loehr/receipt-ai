...
def ensure_directories() -> None:
    (PROJECT_ROOT / "token_autogenerated").mkdir(parents=True, exist_ok=True)
...
def get_credentials_file_path() -> str:
    ...
    folder = PROJECT_ROOT / "cloud_credentials"
...
def unified_google_oauth() -> bool:
    try:
        ...
        token_path = PROJECT_ROOT / "token_autogenerated" / "unified_google_token.json"
